...
const ShopDetails = () => {
  ...
  const mariageProducts = rentProducts?.filter((item) => item.subcategory === "mariage");
  console.log("mariageProducts", mariageProducts);


  useEffect(() => {
    if (displayedProducts.length === 0) {
      setDisplayedProducts(mariageProducts);
    }
     }, [mariageProducts]);
  ...
  return (
    <div className="shopDetails">
      <div className="shopDetailMain">
        <div className="shopDetails__left">
          <Filter rentProducts={mariageProducts} 
